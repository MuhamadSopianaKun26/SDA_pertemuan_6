...
/* bermilai X jika alokasi berhasil. Jika alokasi gagal IS = FS */
...
/* Elemen list berkurang satu (mungkin menjadi kosong) */
/* Last elemen baru adalah predecessor elemen terakhir yang lama, jika ada */
...
/* Mengirimkan address P, dengan info(P) yang bermilai maksimum */

infotype Min(List L);
/* Mengirimkan nilai Info(P) yang minimum */

address AdrMin(List L);
/* Mengirimkan address P, dengan info(P) yang bermilai minimum */
...
/* IS : L sembarang */
/* FS : Elemen List dibalik : elemen terakhir menjadi elemen pertama, dat */
/* Membalik elemen list, tanpa melakukan alokasi / dealokasi */

List FInversList(List L);
/* Mengirimkan list baru, hasil inverse dari L */
...
/* IS : Lin Sembarang */
/* FS : Jika semua alokasi berhasil, maka Lout berisi hasil copy Lin */
...
/* GAGAL, maka L3 harus bermliai nil dan semua elemen yang pernah di */
/* alokasi didealokasi */
